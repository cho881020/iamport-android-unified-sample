...
public class Scheme {
    ...
    public final static String LGU_BANKPAY = "smartxpay-transfer";
    ...
    public final static String PACKAGE_LGU_BANKPAY = "kr.co.uplus.ecredit";
    public final static String PACKAGE_KAKAO = "com.kakao.talk";

    public final static String NICE_BANK_URL = "https://web.nicepay.co.kr/smart/bank/payTrans.jsp";
}
